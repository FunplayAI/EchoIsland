...
pub(super) struct NativePanelHandleViews<'a> {
    ...
    pub(super) settings_button_label: &'a NSTextField,
    pub(super) quit_button: &'a NSView,
    pub(super) quit_button_label: &'a NSTextField,
...
pub(super) fn initialize_native_panel_handles(views: NativePanelHandleViews<'_>) {
    let _ = NATIVE_TEST_PANEL_HANDLES.set(NativePanelHandles {
        ...
        settings_button_label: (views.settings_button_label as *const NSTextField) as usize,
        quit_button: (views.quit_button as *const NSView) as usize,
        quit_button_label: (views.quit_button_label as *const NSTextField) as usize,
