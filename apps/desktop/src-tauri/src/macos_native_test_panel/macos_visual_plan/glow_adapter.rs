...
pub(in crate::macos_native_test_panel) struct MacosCompletionGlowPrimitive {
    pub(in crate::macos_native_test_panel) frame: PanelRect,
    pub(in crate::macos_native_test_panel) opacity: f64,
    pub(in crate::macos_native_test_panel) slices: [CompletionGlowImageSliceSpec; 3],
}

pub(in crate::macos_native_test_panel) fn resolve_macos_completion_glow_visual_plan(
    frame: PanelRect,
    visible: bool,
    base_opacity: f64,
    elapsed_ms: u128,
...
pub(in crate::macos_native_test_panel) fn completion_glow_primitive(
