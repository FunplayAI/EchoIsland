...
pub(in crate::macos_native_test_panel) struct MacosMascotBodyPrimitive {
    pub(in crate::macos_native_test_panel) frame: PanelRect,
    pub(in crate::macos_native_test_panel) corner_radius: f64,
    pub(in crate::macos_native_test_panel) fill: NativePanelVisualColor,
    pub(in crate::macos_native_test_panel) stroke: NativePanelVisualColor,
    pub(in crate::macos_native_test_panel) stroke_width: f64,
    pub(in crate::macos_native_test_panel) shadow_opacity: f64,
    pub(in crate::macos_native_test_panel) shadow_radius: f64,
}

#[derive(Clone, Copy, Debug, PartialEq)]
pub(in crate::macos_native_test_panel) struct MacosMascotEllipsePrimitive {
    pub(in crate::macos_native_test_panel) frame: PanelRect,
    pub(in crate::macos_native_test_panel) color: NativePanelVisualColor,
    pub(in crate::macos_native_test_panel) alpha: f64,
}

#[derive(Clone, Copy, Debug, PartialEq)]
pub(in crate::macos_native_test_panel) struct MacosMascotRoundRectPrimitive {
    pub(in crate::macos_native_test_panel) frame: PanelRect,
    pub(in crate::macos_native_test_panel) radius: f64,
    pub(in crate::macos_native_test_panel) color: NativePanelVisualColor,
    pub(in crate::macos_native_test_panel) alpha: f64,
}

#[derive(Clone, Debug, PartialEq)]
pub(in crate::macos_native_test_panel) struct MacosMascotTextPrimitive {
    pub(in crate::macos_native_test_panel) origin: PanelPoint,
    pub(in crate::macos_native_test_panel) max_width: f64,
    pub(in crate::macos_native_test_panel) text: String,
    pub(in crate::macos_native_test_panel) color: NativePanelVisualColor,
    pub(in crate::macos_native_test_panel) size: i32,
    pub(in crate::macos_native_test_panel) weight: NativePanelVisualTextWeight,
    pub(in crate::macos_native_test_panel) alpha: f64,
}

#[derive(Clone, Debug, PartialEq)]
pub(in crate::macos_native_test_panel) struct MacosMascotMessageBubblePrimitive {
    pub(in crate::macos_native_test_panel) bubble: MacosMascotRoundRectPrimitive,
    pub(in crate::macos_native_test_panel) dots: Vec<MacosMascotEllipsePrimitive>,
}

#[derive(Clone, Debug, PartialEq)]
pub(in crate::macos_native_test_panel) struct MacosMascotCompletionBadgePrimitive {
    pub(in crate::macos_native_test_panel) outline: MacosMascotRoundRectPrimitive,
    pub(in crate::macos_native_test_panel) fill: MacosMascotRoundRectPrimitive,
    pub(in crate::macos_native_test_panel) label: MacosMascotTextPrimitive,
}

pub(in crate::macos_native_test_panel) fn resolve_macos_mascot_visual_plan(
...
pub(in crate::macos_native_test_panel) fn mascot_body_primitive(
...
pub(in crate::macos_native_test_panel) fn mascot_eye_primitive(
    plan: &NativePanelVisualPlan,
    left: bool,
...
pub(in crate::macos_native_test_panel) fn mascot_mouth_primitive(
    plan: &NativePanelVisualPlan,
) -> Option<MacosMascotRoundRectPrimitive> {
    mascot_round_rect_primitive(plan, NativePanelVisualMascotRoundRectRole::Mouth)
}

pub(in crate::macos_native_test_panel) fn mascot_message_bubble_primitive(
    plan: &NativePanelVisualPlan,
...
pub(in crate::macos_native_test_panel) fn mascot_sleep_label_primitive(
    plan: &NativePanelVisualPlan,
) -> Option<MacosMascotTextPrimitive> {
    mascot_text_primitive(plan, NativePanelVisualMascotTextRole::SleepLabel)
}

pub(in crate::macos_native_test_panel) fn mascot_completion_badge_primitive(
    plan: &NativePanelVisualPlan,
...
pub(in crate::macos_native_test_panel) fn apply_macos_mascot_body_primitive(
    mascot_body: &NSView,
