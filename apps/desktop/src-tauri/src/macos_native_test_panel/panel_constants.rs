...
pub(super) const MAX_VISIBLE_SESSIONS: usize = 5;
pub(super) const PROMPT_ASSIST_RUNNING_SECONDS: i64 = 12;
pub(super) const PROMPT_ASSIST_PROCESSING_SECONDS: i64 = 18;
pub(super) const PROMPT_ASSIST_RECENT_SECONDS: i64 = 20 * 60;
...
pub(super) const PANEL_CLOSE_SHOULDER_MS: u64 = 120;
...
pub(super) const PANEL_CARD_EXIT_STAGGER_MS: u64 = 38;
...
pub(super) const SHARED_CONTENT_REVEAL_PROGRESS: f64 = 0.94;
pub(super) const SHARED_CONTENT_INTERACTIVE_PROGRESS: f64 = 0.985;
