...
pub(super) unsafe fn resolve_native_panel_refs(handles: NativePanelHandles) -> NativePanelRefs {
    NativePanelRefs {
        ...
        completion_glow: view_from_ptr(handles.completion_glow),
        ...
        settings_button_label: text_field_from_ptr(handles.settings_button_label),
        quit_button: view_from_ptr(handles.quit_button),
        quit_button_label: text_field_from_ptr(handles.quit_button_label),
