...
pub(crate) struct MacosNativePanelRuntimeBackendApi;

impl NativePanelPlatformRuntimeFacadeApi for MacosNativePanelRuntimeBackendApi {
...
pub(crate) type MacosNativePanelRuntimeBackendFacade =
    NativePanelPlatformRuntimeBackendFacade<MacosNativePanelRuntimeBackendApi>;
