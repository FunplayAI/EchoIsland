...
[![Platform: Windows + macOS](https://img.shields.io/badge/platform-Windows%20%2B%20macOS-blue)]()
[![Built with Tauri + Rust](https://img.shields.io/badge/built%20with-Tauri%20%2B%20Rust-orange)]()
[![GitHub Stars](https://img.shields.io/github/stars/FunplayAI/EchoIsland?style=social)](https://github.com/FunplayAI/EchoIsland)
...
| 模块 | 状态 | 说明 |
|:---|:---|:---|
| **Windows 桌面端** | ✅ 主平台 | Tauri/Web UI、异形悬浮岛、安装包构建 |
